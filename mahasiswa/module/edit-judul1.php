<?php
	...
	$query = "SELECT nim, mahasiswa, judul1, desjudul1, kelas, pembimbing1, disetujui, prodi FROM skripsi WHERE nim ='$nim'";
				    ...
				    <div class="panel panel-success" style="box-shadow: 0 2px 5px 0 rgba(0, 0, 0, 0.16), 0 2px 10px 0 rgba(0, 0, 0, 0.12);">
				      ...
				      <form action="module/update-judul.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name = "judul1" class="form-control" placeholder="Masukan Judul Skripsi Anda." value="<?php if(isset($judul)) { echo $judul; } ?>" required>
                            </div>
                            <div class="form-group">
                                <label for="judul">Descriptions Judul</label>
                                <textarea rows="5" name="desjudul1" class="form-control" placeholder="Here can be your description" required><?php if(isset($desjudul)) { echo $desjudul; } ?></textarea>
                            </div>                            
